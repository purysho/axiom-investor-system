  ...
  return (
    <div className="mx-auto max-w-2xl px-5 py-14">
      ...
      <div className="mt-8 space-y-6 text-[15px] leading-relaxed text-mut">
        ...
        <p><span className="font-semibold text-ink">Cookies.</span> One session cookie to keep you signed in (or one flag cookie for offline mode). No ads, no trackers, no analytics.</p>
